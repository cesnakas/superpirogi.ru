...
<div class="news-detail<?=$themeClass?>">
	<div class="mb-3 sdsd" id="<?echo $this->GetEditAreaId($arResult['ID'])?>">
		...
		<?if($arParams["DISPLAY_PICTURE"]!="N"):?>
			...
			{
				?>
				<div class="mb-5 news-detail">
					<div class="news-detail">
							<div  class="news-detail-slider-slide">
...
<style>
.sdsd {display: flex;}
.news-detail-body {width: 50%;padding-left: 45px;}
.mb-5.news-detail-img {width: 50%;}
@media(max-width:1180px){.sdsd {display: block;}.news-detail-body {width: 100%;}.mb-5.news-detail-img {width: 100%;}}
p.backdoors a {border: 1px solid #edd081;padding: 15px;border-radius: 50px;text-decoration: none;}
p.backdoors a:hover {background: #edd081;}
</style>
