...
<div class="section_heading"><h1><?print_r($arResult['NAME']);?></h1></div>
...
<?=$arResult['DESCRIPTION'][0]?>
</section>
		<div class="mb-4 catalog-section catalog_wrap" data-entity="<?=$containerName?>">
			<!-- items-container -->
			<?
		...
		<section class="text_block">
<?=$arResult['DESCRIPTION'][1]?>
			</section>
			<style>
			section.text_block {
    border-top: 3px solid #edd081;
}
			</style>
<!-- component-end -->