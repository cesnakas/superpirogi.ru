...
<div class="section_heading"><h2><?print_r($arResult['NAME']);?></h2></div>
...
<?$arResult['DESCRIPTION']=explode('<hr>',$arResult['DESCRIPTION']);?>
		<div class="mb-4 catalog-section catalog_wrap sliderprood" data-entity="<?=$containerName?>">
			<!-- items-container -->
			<?
		...
		<script>
			...
			<style>
			section.text_block {border-top: 3px solid #edd081;}
			@media(min-width:555px) {
				.catalog_item {width: 85%;}
				.catalog_item {min-height: 443px;}
				.catalog_item-name a {font-size: 24px;}
				ul.product-item-scu-item-list.rrrrr {top: -10px;position: relative;}
			}
			</style>
<!-- component-end -->