...
<section class="index_moscow center" style="background: #F5F5F5;padding-top: 50px;padding-bottom: 50px;">
	...
	}elseif($arParams["IBLOCK_ID"] == '19'){?>
		<p>

		Сытный обед с друзьями, уютный ужин в кругу семьи или перекус с коллегами на скорую руку? Какой бы ни был повод, осетинские пироги от пекарни «Супер пироги» — всегда к месту! Заказывайте самые вкусные и ароматные, свежие и горячие настоящие осетинские пироги с доставкой в районе метро <?echo $arResult["NAME"];?>.
		</p>
		<p>
		Выбирайте: сладкие или соленые, рыбные или мясные, с творогом, грибами или сыром, постные или вегетарианские. А еще у нас есть пикантная пицца с хрустящей корочкой, закуски и напитки домашнего приготовления!
		</p>
		<p>
		Запоминайте: пекарня «Супер пироги» — самые вкусные осетинские пироги на ст.м. <?echo $arResult["NAME"];?>!
		</p>
	<?}elseif($arParams["IBLOCK_ID"] == '20'){?>
		<p>
		Сытный обед с друзьями, уютный ужин в кругу семьи или перекус с коллегами на скорую руку? Какой бы ни был повод, осетинские пироги от пекарни «Супер пироги» — всегда к месту! Заказывайте самые вкусные и ароматные, свежие и горячие настоящие осетинские пироги с доставкой в районе <?echo $arResult["NAME"];?>.
		</p>
		<p>
		Выбирайте: сладкие или соленые, рыбные или мясные, с творогом, грибами или сыром, постные или вегетарианские. А еще у нас есть пикантная пицца с хрустящей корочкой, закуски и напитки домашнего приготовления!
		</p>
		<p>
		Запоминайте: пекарня «Супер пироги» — самые вкусные осетинские пироги в районе <?echo $arResult["NAME"];?>!
		</p>
	<?}?>
