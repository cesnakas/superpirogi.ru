...
$APPLICATION->SetPageProperty("description", "Постоянным клиентам скидка 10% - акция пекарни «Супер Пироги»");
$APPLICATION->SetPageProperty("title", "Постоянным клиентам скидка 10% - «Супер Пироги»");
...
<style>
.sales_item img {clip-path: polygon(46% 0, 100% 0%, 100% 100%, 12% 100%);}
.sales_item-name {font-size: 41px !important;width: 50% !important;}
.sales_item-description {font-size: 14px !important; width: 100%;}
</style>
